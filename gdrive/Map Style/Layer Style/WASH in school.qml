...
<qgis maxScale="0" minScale="1e+08" styleCategories="AllStyleCategories" simplifyDrawingHints="0" simplifyLocal="1" simplifyAlgorithm="0" version="3.6.2-Noosa" hasScaleBasedVisibilityFlag="0" readOnly="0" simplifyDrawingTol="1" simplifyMaxScale="1" labelsEnabled="0">
    ...
    <symbols>
      <symbol force_rhr="0" clip_to_extent="1" name="0" type="marker" alpha="1">
        <layer locked="0" pass="0" class="SimpleMarker" enabled="1">
          ...
          <prop k="outline_color" v="147,8,171,255"/>
  ...
  <aliases>
    <alias index="0" name="" field="SL"/>
    <alias index="1" name="" field="Latitude"/>
    <alias index="2" name="" field="Longitude"/>
    <alias index="3" name="" field="field_4"/>
    <alias index="4" name="" field="field_5"/>
    <alias index="5" name="" field="field_6"/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default applyOnUpdate="0" field="SL" expression=""/>
    <default applyOnUpdate="0" field="Latitude" expression=""/>
    <default applyOnUpdate="0" field="Longitude" expression=""/>
    <default applyOnUpdate="0" field="field_4" expression=""/>
    <default applyOnUpdate="0" field="field_5" expression=""/>
    <default applyOnUpdate="0" field="field_6" expression=""/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" field="SL" constraints="0" exp_strength="0" notnull_strength="0"/>
    ...
    <constraint unique_strength="0" field="field_4" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="field_5" constraints="0" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="field_6" constraints="0" exp_strength="0" notnull_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint exp="" desc="" field="SL"/>
    <constraint exp="" desc="" field="Latitude"/>
    <constraint exp="" desc="" field="Longitude"/>
    <constraint exp="" desc="" field="field_4"/>
    <constraint exp="" desc="" field="field_5"/>
    <constraint exp="" desc="" field="field_6"/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      <column name="SL" width="-1" type="field" hidden="0"/>
